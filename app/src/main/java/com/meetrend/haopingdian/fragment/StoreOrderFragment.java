...
import com.meetrend.haopingdian.fragment.AllOrderFragment.TabAdapter;
...
private final String[] TASNAMES = new String[]{"待付款","待发货","已完成","已取消"};
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		//待付款
		BaseFragment mWaitPayFragment = new OrderManagerChildFragment("UnPay", 1+"",1);
		//待发货
		BaseFragment mWaitSendFragment = new OrderManagerChildFragment("Payed", 1+"",2);
		//已完成
		BaseFragment mWaitFinishFragment = new OrderManagerChildFragment("Finished", 1+"",3);
		//已取消
		BaseFragment mWaitCancelFragment = new OrderManagerChildFragment("Canceled", 1+"",4);
		...
		//mViewPager.setAdapter(new TabAdapter(getActivity().getSupportFragmentManager()));
