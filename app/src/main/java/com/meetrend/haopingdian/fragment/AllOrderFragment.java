...
public class AllOrderFragment extends BaseFragment{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		//待确认
		BaseFragment mWaitConfirmFragment = new OrderManagerChildFragment("Unconfirmed", 0+"",0);
		
		//待付款
		BaseFragment mWaitPayFragment = new OrderManagerChildFragment("UnPay", 0+"",1);
		//待发货
		BaseFragment mWaitSendFragment = new OrderManagerChildFragment("Payed", 0+"",2);
		//已完成
		BaseFragment mWaitFinishFragment = new OrderManagerChildFragment("Finished", 0+"",3);
		//已取消
		BaseFragment mWaitCancelFragment = new OrderManagerChildFragment("Canceled", 0+"",4);
