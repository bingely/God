...
package com.meetrend.haopingdian.pulltorefresh.library;
...
import com.meetrend.haopingdian.pulltorefresh.library.internal.FlipLoadingLayout;
import com.meetrend.haopingdian.pulltorefresh.library.internal.LoadingLayout;
import com.meetrend.haopingdian.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private float mInitialMotionX, mInitialMotionY;//����ʱ��x,y����

	private boolean mIsBeingDragged = false;//��ڱ���ק
	...
	private Interpolator mScrollAnimationInterpolator;//������ֵ��
	...
	public final boolean onInterceptTouchEvent(MotionEvent event) {
		...
		switch (action) {
			case MotionEvent.ACTION_MOVE: {
				// If we're refreshing, and the flag is set. Eat all MOVE events   #Eat:����
...
//				break;
		...
		switch (mCurrentMode) {
			case PULL_FROM_END:
				newScrollValue = Math.round(Math.max(initialMotionValue - lastMotionValue, 0) / FRICTION);//ֵ����0
				itemDimension = getFooterSize();
				break;
			case PULL_FROM_START:
			default:
				newScrollValue = Math.round(Math.min(initialMotionValue - lastMotionValue, 0) / FRICTION);//ֵС��0
				itemDimension = getHeaderSize();
				break;
		}
        Log.i("------------newScrollValue----------", newScrollValue+"");
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		private final int mScrollToY;//Ŀ��λ��(Ҫ��������λ��)
		private final int mScrollFromY;//��ʼλ��
