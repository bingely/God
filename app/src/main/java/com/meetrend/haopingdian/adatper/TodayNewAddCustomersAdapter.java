...
public class TodayNewAddCustomersAdapter extends BasicAdapter{
	
	public TodayNewAddCustomersAdapter(List<OrderBean> list, Context context) {
		super(list, context);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String str = "新增数："+ (int)Math.floor(orderBean.Num);
