...
public class TodayOrderListAdapter extends BasicAdapter{
	
	public TodayOrderListAdapter(List<OrderBean> list, Context context) {
		super(list, context);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String str = "下单数："+ (int)Math.floor(orderBean.Num);
