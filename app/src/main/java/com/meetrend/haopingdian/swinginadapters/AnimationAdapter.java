 ...
 */
package com.meetrend.haopingdian.swinginadapters;
...
import com.meetrend.haopingdian.listviewanimations.BaseAdapterDecorator;
 ...
 * 
 * 动画执行条件：当前的position大于LastPosition执行动画，否则不执行
 */
