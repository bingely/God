...
public class WebViewActiity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMyWeb.loadUrl(webUrl+"&token=" +SPUtil.getDefault(WebViewActiity.this).getToken() + "&from=app");
